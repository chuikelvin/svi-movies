...
ARG NEXT_PUBLIC_TMDB_BEARER_TOKEN
...
# Set client-side environment variables (exposed to browser)
...
# Set server-side environment variables (not exposed to browser)
ENV NEXT_PUBLIC_TMDB_BEARER_TOKEN=${NEXT_PUBLIC_TMDB_BEARER_TOKEN}
